...
const Header = () => {
  ...
  const toggleMenu = () => {
    ...
    Animated.timing(sideMenuAnim, {
      toValue: menuOpen ? -250 : 0, // Move o menu para dentro ou para fora
      duration: 300,
  ...
  return (
    <View style={styles.header}>
      ...
      {/* Modais (Login e Nova Conta) */}
      {showLogin && <View style={styles.overlay}><Text>Login Component</Text></View>}
      {showNewUser && <View style={styles.overlay}><Text>New Account Component</Text></View>}
    </View>
  );
};
